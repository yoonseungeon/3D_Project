...
HRESULT CAIFiora::Ready_PartObjects()
{
	...
	// W_Effect_1
	CFiora_W_1::FIORA_W_1_DESC WEffectDesc{};
	WEffectDesc.pParentMatrix = m_pTransformCom->Get_WorldMatrixPtr();

	if (FAILED(__super::Add_PartObject(ETOUI(LEVEL::GAMEPLAY), TEXT("Prototype_GameObject_CFiora_W_1"),
