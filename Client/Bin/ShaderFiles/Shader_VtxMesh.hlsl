...
VS_OUT_OUTLINE VS_MAIN_OUTLINE(VS_IN In)
{
    ...
    vPosition.xyz += normalize(In.vNormal.xyz) * g_OutLineLength;
...
technique11 DefaultTechnique
{
    ...
    pass OutLineNoDepthTest
    {
        SetRasterizerState(RS_Cull_CW);
        SetDepthStencilState(DSS_StencilReadNoDepthTest, 1);
        SetBlendState(BS_AlphaBlend, float4(0.f, 0.f, 0.f, 0.f), 0xffffffff);  //alphablend
    ...
    pass DefaultStencilWrite
    {
        SetRasterizerState(RS_Default);
        SetDepthStencilState(DSS_StencilWrite, 1);
        SetBlendState(BS_Default, float4(0.f, 0.f, 0.f, 0.f), 0xffffffff);
