...
{
public:
	enum BLENDSTATE { DEFAULT, ALPHATEST, ALPHABLEND, ALPHABLEDN_LOBBY_TAB_BTN, MASK, COLOR_ALPHABLEND, CHARPROFILE, ALPHABLEND_GAUGE, INGAME_HPBAR, SKILL_ICON, SKILL_COOL, SHOCKWAVE, LAVA, DRAGON_R, DAILINE_W };
