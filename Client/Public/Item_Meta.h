...
static ITEM_DESC ItemInfos[89] = {
    ...
    { 4,  4,  L"목장갑",        L"None", (MAP_NAME)0, ITEM_TYPE::GLOVE,    ITEM_GRADE::NORMAL,  7,  0,    0.f, 0,  0,   0.f, 0,   0.f,     0, 1, 1, {-1, -1} },
    ...
    { 10, 10, L"쇠사슬",        L"None", (MAP_NAME)0, ITEM_TYPE::NUNCHAKU, ITEM_GRADE::NORMAL, 13,  0,    0.f, 0,  0,   0.f, 0,   0.f,     0, 1, 1, {-1, -1} },
    { 11, 11, L"머리띠",        L"None", (MAP_NAME)0, ITEM_TYPE::HEAD, ITEM_GRADE::NORMAL,      0,  0,    0.f, 0,  1,   0.f, 0,   0.f,     0, 1, 1, {-1, -1} },
    { 12, 12, L"모자",          L"None", (MAP_NAME)0, ITEM_TYPE::HEAD, ITEM_GRADE::NORMAL,      0,  0,    0.f, 0,  2,   0.f, 0,   0.f,     0, 1, 1, {-1, -1} },
    { 13, 13, L"자전거 헬멧",   L"None", (MAP_NAME)0, ITEM_TYPE::HEAD, ITEM_GRADE::NORMAL,      0, 30,    0.f, 0,  0,   0.f, 0,   0.f,     0, 1, 1, {-1, -1} },
    { 14, 14, L"가면",          L"None", (MAP_NAME)0, ITEM_TYPE::HEAD, ITEM_GRADE::NORMAL,      0, 20,    0.f, 0,  0,   0.f, 0,   0.f,     0, 1, 1, {-1, -1} },
    { 15, 15, L"바람막이",      L"None", (MAP_NAME)0, ITEM_TYPE::CLOTH, ITEM_GRADE::NORMAL,     4,  0,    0.f, 0,  3,   0.f, 0,   0.f,     0, 1, 1, {-1, -1} },
    { 16, 16, L"승복",          L"None", (MAP_NAME)0, ITEM_TYPE::CLOTH, ITEM_GRADE::NORMAL,     0,  0,    0.f, 0,  9,   0.f, 0,   0.f,     0, 1, 1, {-1, -1} },
    { 17, 17, L"전신 수영복",   L"None", (MAP_NAME)0, ITEM_TYPE::CLOTH, ITEM_GRADE::NORMAL,     0,  0,    0.f, 0,  9,   0.f, 0,   0.f,     0, 1, 1, {-1, -1} },
    { 18, 18, L"셔츠",          L"None", (MAP_NAME)0, ITEM_TYPE::CLOTH, ITEM_GRADE::NORMAL,     0,  0,    0.f, 0,  9,   0.f, 0,   0.f,     0, 1, 1, {-1, -1} },
    { 19, 19, L"손목시계",      L"None", (MAP_NAME)0, ITEM_TYPE::ARM, ITEM_GRADE::NORMAL,       0,  0,    0.f, 0,  0,   8.f, 0,   0.f,     0, 1, 1, {-1, -1} },
    { 20, 20, L"붕대",          L"None", (MAP_NAME)0, ITEM_TYPE::ARM, ITEM_GRADE::NORMAL,       0,  0,   20.f, 0,  0,   0.f, 0,   0.f,     0, 1, 1, {-1, -1} },
    { 21, 21, L"팔찌",          L"None", (MAP_NAME)0, ITEM_TYPE::ARM, ITEM_GRADE::NORMAL,       0,  0,    0.f, 0,  2,   0.f, 0,   0.f,     0, 1, 1, {-1, -1} },
    { 22, 22, L"슬리퍼",        L"None", (MAP_NAME)0, ITEM_TYPE::LEG, ITEM_GRADE::NORMAL,       0,  0,    0.f, 0,  0,   0.f, 0, 0.12f,     0, 1, 1, {-1, -1} },
    { 23, 23, L"운동화",        L"None", (MAP_NAME)0, ITEM_TYPE::LEG, ITEM_GRADE::NORMAL,       0,  0,    0.f, 0,  0,   0.f, 0, 0.12f,     0, 1, 1, {-1, -1} },
    { 24, 24, L"타이즈",        L"None", (MAP_NAME)0, ITEM_TYPE::LEG, ITEM_GRADE::NORMAL,       0,  0,    0.f, 0,  0,   0.f, 0, 0.12f,     0, 1, 1, {-1, -1} },
    { 25, 25, L"나막신",        L"None", (MAP_NAME)0, ITEM_TYPE::LEG, ITEM_GRADE::NORMAL,       0,  0,    0.f, 0,  0,   0.f, 0, 0.12f,     0, 1, 1, {-1, -1} },
    ...
    // HIGH                                                                                                                               
    { 53, 53, L"글러브",        L"None", (MAP_NAME)0, ITEM_TYPE::GLOVE,    ITEM_GRADE::HIGH,   18, 0,    0.f, 0,  0,   0.f, 0,    0.f,     0, 1, 1, {4 , 34} },
    { 54, 54, L"아이언 너클",   L"None", (MAP_NAME)0, ITEM_TYPE::GLOVE,    ITEM_GRADE::HIGH,   20, 0,    0.f, 0,  0,   0.f, 0,    0.f,     0, 1, 1, {4 , 37} },
    { 55, 55, L"눈차크",        L"None", (MAP_NAME)0, ITEM_TYPE::NUNCHAKU, ITEM_GRADE::HIGH,   25, 0,    0.f, 0,  0,   0.f, 0,    0.f,     0, 1, 1, {10, 49} },
    { 56, 56, L"사슬 코이프",   L"None", (MAP_NAME)0, ITEM_TYPE::HEAD,     ITEM_GRADE::HIGH,    0, 0,    0.f, 0,  3,   0.f, 0,    0.f,     0, 1, 1, {12, 51} },
    { 57, 57, L"잠수복",        L"None", (MAP_NAME)0, ITEM_TYPE::CLOTH,    ITEM_GRADE::HIGH,    0, 0,    0.f, 0, 10,   0.f, 0,    0.f,     0, 1, 1, {18, 36} },
    { 58, 58, L"분대장 완장",   L"None", (MAP_NAME)0, ITEM_TYPE::ARM,      ITEM_GRADE::HIGH,    0, 0,   25.f, 0,  0,   0.f, 0,    0.f,     0, 1, 1, {20, 46} },
    { 59, 59, L"하이힐",        L"None", (MAP_NAME)0, ITEM_TYPE::LEG,      ITEM_GRADE::HIGH,    2, 0,    0.f, 0,  0,   0.f, 0,  0.16f,     0, 1, 1, {23, 33} },
    { 60, 60, L"운명의 꽃",     L"None", (MAP_NAME)0, ITEM_TYPE::MATERIAL, ITEM_GRADE::HIGH,    0, 0,    0.f, 0,  0,   0.f, 0,    0.f,     0, 1, 2, {27, 44} },
    { 61, 61, L"유리 조각",     L"None", (MAP_NAME)0, ITEM_TYPE::MATERIAL, ITEM_GRADE::HIGH,    0, 0,    0.f, 0,  0,   0.f, 0,    0.f,     0, 1, 2, {7 ,  5} },
    { 62, 62, L"화살통",        L"None", (MAP_NAME)0, ITEM_TYPE::MATERIAL, ITEM_GRADE::HIGH,    0, 0,    0.f, 0,  0,   0.f, 0,    0.f,     0, 1, 2, {26,  3} },
    { 63, 63, L"비파단도",      L"None", (MAP_NAME)0, ITEM_TYPE::MATERIAL, ITEM_GRADE::HIGH,    0, 0,    0.f, 0,  0,   0.f, 0,    0.f,     0, 1, 2, {44, 51} },
    { 64, 64, L"기름먹인 천",   L"None", (MAP_NAME)0, ITEM_TYPE::MATERIAL, ITEM_GRADE::HIGH,    0, 0,    0.f, 0,  0,   0.f, 0,    0.f,     0, 1, 2, {42, 20} },
    { 65, 65, L"재",            L"None", (MAP_NAME)0, ITEM_TYPE::MATERIAL, ITEM_GRADE::HIGH,    0, 0,    0.f, 0,  0,   0.f, 0,    0.f,     0, 1, 2, {45, 38} },
    { 66, 66, L"전자 부품",     L"None", (MAP_NAME)0, ITEM_TYPE::MATERIAL, ITEM_GRADE::HIGH,    0, 0,    0.f, 0,  0,   0.f, 0,    0.f,     0, 1, 2, {41, 50} },
    { 67, 67, L"정교한 도면",   L"None", (MAP_NAME)0, ITEM_TYPE::MATERIAL, ITEM_GRADE::HIGH,    0, 0,    0.f, 0,  0,   0.f, 0,    0.f,     0, 1, 2, {1 , 45} },
    { 68, 68, L"철판",          L"None", (MAP_NAME)0, ITEM_TYPE::MATERIAL, ITEM_GRADE::HIGH,    0, 0,    0.f, 0,  0,   0.f, 0,    0.f,     0, 1, 2, {37, 47} },
    { 69, 69, L"황금",          L"None", (MAP_NAME)0, ITEM_TYPE::MATERIAL, ITEM_GRADE::HIGH,    0, 0,    0.f, 0,  0,   0.f, 0,    0.f,     0, 1, 2, {2 , 44} },
    { 70, 70, L"철사",          L"None", (MAP_NAME)0, ITEM_TYPE::MATERIAL, ITEM_GRADE::HIGH,    0, 0,    0.f, 0,  0,   0.f, 0,    0.f,     0, 1, 2, {50, 49} },
    { 71, 71, L"루비",          L"None", (MAP_NAME)0, ITEM_TYPE::MATERIAL, ITEM_GRADE::HIGH,    0, 0,    0.f, 0,  0,   0.f, 0,    0.f,     0, 1, 2, {38, 44} },
    { 72, 72, L"하드커버",      L"None", (MAP_NAME)0, ITEM_TYPE::MATERIAL, ITEM_GRADE::HIGH,    0, 0,    0.f, 0,  0,   0.f, 0,    0.f,     0, 1, 2, {45, 34} },
    { 73, 73, L"다이아몬드",    L"None", (MAP_NAME)0, ITEM_TYPE::MATERIAL, ITEM_GRADE::HIGH,    0, 0,    0.f, 0,  0,   0.f, 0,    0.f,     0, 1, 2, {48, 38} },
    { 74, 74, L"독약",          L"None", (MAP_NAME)0, ITEM_TYPE::MATERIAL, ITEM_GRADE::HIGH,    0, 0,    0.f, 0,  0,   0.f, 0,    0.f,     0, 1, 2, {47,  7} },
    ...
    { 83, 83, L"블리더",        L"None", (MAP_NAME)0, ITEM_TYPE::NUNCHAKU, ITEM_GRADE::RARE,   30, 0,    0.f, 0,  0,   0.f, 0,    0.f,     0, 1, 1, {55, 33} },
    // HERO                                                                                                                                
    { 84, 84, L"초진동눈차크",  L"None", (MAP_NAME)0, ITEM_TYPE::NUNCHAKU, ITEM_GRADE::HERO,   63, 0,    0.f, 0,  0,   0.f, 0,    0.f,     0, 1, 1, {83, 41} },
    { 85, 85, L"플라즈마 투구", L"None", (MAP_NAME)0, ITEM_TYPE::HEAD,     ITEM_GRADE::HERO,   35, 0,    0.f, 8,  0,   0.f, 0,  0.06f,     0, 1, 1, {56, 75} }, // 이속
    { 86, 86, L"고스트",        L"None", (MAP_NAME)0, ITEM_TYPE::CLOTH,    ITEM_GRADE::HERO,   14, 0,    0.f, 0, 18,   0.f, 34,   0.f,     0, 1, 1, {57, 61} },
    { 87, 87, L"미닛맨의 표식", L"None", (MAP_NAME)0, ITEM_TYPE::ARM,      ITEM_GRADE::HERO,   25, 0,    0.f, 0,  0, 0.15f, 24,   0.f,     0, 1, 1, {58, 60} }, // 공속
    { 88, 88, L"부케팔로스",    L"None", (MAP_NAME)0, ITEM_TYPE::LEG,      ITEM_GRADE::HERO,    8, 0,    0.f, 0,  0,   0.f, 25, 0.22f,     0, 1, 1, {59, 61} }
};
