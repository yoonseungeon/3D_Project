...
static ITEM_DESC ItemInfos[89] = {
    ...
    { 11, 11, L"머리띠",        L"None", (MAP_NAME)0, ITEM_TYPE::MATERIAL, ITEM_GRADE::NORMAL, 0,  0,    0.f, 0,  1,  0.f, 0, 0.f,     0, 1, 1, {-1, -1} },
    { 12, 12, L"모자",          L"None", (MAP_NAME)0, ITEM_TYPE::MATERIAL, ITEM_GRADE::NORMAL, 0,  0,    0.f, 0,  2,  0.f, 0, 0.f,     0, 1, 1, {-1, -1} },
    { 13, 13, L"자전거 헬멧",   L"None", (MAP_NAME)0, ITEM_TYPE::MATERIAL, ITEM_GRADE::NORMAL, 0,  30,   0.f, 0,  0,  0.f, 0, 0.f,     0, 1, 1, {-1, -1} },
    { 14, 14, L"가면",          L"None", (MAP_NAME)0, ITEM_TYPE::MATERIAL, ITEM_GRADE::NORMAL, 0,  20,   0.f, 0,  0,  0.f, 0, 0.f,     0, 1, 1, {-1, -1} },
    { 15, 15, L"바람막이",      L"None", (MAP_NAME)0, ITEM_TYPE::MATERIAL, ITEM_GRADE::NORMAL, 4,  0,    0.f, 0,  3,  0.f, 0, 0.f,     0, 1, 1, {-1, -1} },
    { 16, 16, L"승복",          L"None", (MAP_NAME)0, ITEM_TYPE::MATERIAL, ITEM_GRADE::NORMAL, 0,  0,    0.f, 0,  9,  0.f, 0, 0.f,     0, 1, 1, {-1, -1} },
    { 17, 17, L"전신 수영복",   L"None", (MAP_NAME)0, ITEM_TYPE::MATERIAL, ITEM_GRADE::NORMAL, 0,  0,    0.f, 0,  9,  0.f, 0, 0.f,     0, 1, 1, {-1, -1} },
    { 18, 18, L"셔츠",          L"None", (MAP_NAME)0, ITEM_TYPE::MATERIAL, ITEM_GRADE::NORMAL, 0,  0,    0.f, 0,  9,  0.f, 0, 0.f,     0, 1, 1, {-1, -1} },
    { 19, 19, L"손목시계",      L"None", (MAP_NAME)0, ITEM_TYPE::MATERIAL, ITEM_GRADE::NORMAL, 0,  0,    0.f, 0,  0,  8.f, 0, 0.f,     0, 1, 1, {-1, -1} },
    { 20, 20, L"붕대",          L"None", (MAP_NAME)0, ITEM_TYPE::MATERIAL, ITEM_GRADE::NORMAL, 0,  0,   20.f, 0,  0,  0.f, 0, 0.f,     0, 1, 1, {-1, -1} },
    { 21, 21, L"팔찌",          L"None", (MAP_NAME)0, ITEM_TYPE::MATERIAL, ITEM_GRADE::NORMAL, 0,  0,    0.f, 0,  2,  0.f, 0, 0.f,     0, 1, 1, {-1, -1} },
    { 22, 22, L"슬리퍼",        L"None", (MAP_NAME)0, ITEM_TYPE::MATERIAL, ITEM_GRADE::NORMAL, 0,  0,    0.f, 0,  0,  0.f, 0, 0.12f,   0, 1, 1, {-1, -1} },
    { 23, 23, L"운동화",        L"None", (MAP_NAME)0, ITEM_TYPE::MATERIAL, ITEM_GRADE::NORMAL, 0,  0,    0.f, 0,  0,  0.f, 0, 0.12f,   0, 1, 1, {-1, -1} },
    { 24, 24, L"타이즈",        L"None", (MAP_NAME)0, ITEM_TYPE::MATERIAL, ITEM_GRADE::NORMAL, 0,  0,    0.f, 0,  0,  0.f, 0, 0.12f,   0, 1, 1, {-1, -1} },
    { 25, 25, L"나막신",        L"None", (MAP_NAME)0, ITEM_TYPE::MATERIAL, ITEM_GRADE::NORMAL, 0,  0,    0.f, 0,  0,  0.f, 0, 0.12f,   0, 1, 1, {-1, -1} },
