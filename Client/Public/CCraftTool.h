...
class CCraftTool final : public CPartObject
{
public:
	struct CRAFTTOOL_DESC : public CPartObject::PARTOBJECT_DESC
	{
...
public:
	enum CRAFTTOOL_ANI { APPEAR, CRAFT };

protected:
	CCraftTool(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CCraftTool(const CCraftTool& Prototype);
