...
namespace Client
{
	...
	enum class SOUND_KEY { BGM_LOBBY, BGM_SELECT, LOBBY_TAB_HOVER, LOBBY_TAB_CLICK, CHAR_HOVER, CHAR_CLICK, SELECT_CLICK, GAMESTART_CLICK,
	LIDAILIN_SELECT, HYUNWOO_SELECT };
	enum class SOUND_CHANNEL_LOBBY { BGM, SKIN_SELECT };
