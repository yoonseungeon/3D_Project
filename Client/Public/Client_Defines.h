...
namespace Client
{
	...
	enum class UILAYER {BACKGROUND, DECO_LAYER1, DECO_LAYER2, DECO_LAYER3, PANEL, PANEL_DECO, SLOT, BUTTON_IMAGE, BUTTON, BUTTON_IMAGE_OVER, PANEL_OVER, PANEL_DECO_OVER};
